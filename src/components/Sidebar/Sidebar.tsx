...
type SidebarPropsType={
    setDataToShow: React.Dispatch<React.SetStateAction<ProductsType[]>>,
    isExpanded:boolean,
...
const Sidebar = ({setDataToShow,isExpanded,setIsSearching}:SidebarPropsType) => {
    ...
    const[filterData,setFilterData]=useState<FilterDataType>({category:[],price:[],rating:[]})
...
if(filterData.category.length===0&&filterData.price.length===0&&filterData.rating.length===0){
    setDataToShow(products);setIsSearching(false);return}
